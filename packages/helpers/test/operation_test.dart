...
void main() {
  group('TSimpleOperation', () {
    ...
    test('length returns the correct length for an operation with one operand',
        () {
    ...
    test(
        'length returns the correct length for an operation with multiple operands and an operator',
        () {
      const op =
    ...
    test(
        'length returns the correct length for an operation with no operands and a null operator',
        () {
    ...
    test(
        'length returns the correct length for an operation with no operands and a non-null operator',
        () {
    ...
    test(
        'length returns the correct length for an operation with empty operands and a non-null operator',
        () {
      const op = TSimpleOperation(operands: ['', ''], operator: '-');
      expect(op.length, 1);
    });
    ...
    test(
        'length returns the correct length for an operation with a null operator and non-null operands',
        () {
      const op = TSimpleOperation(operands: ['123', '456'], operator: null);
      expect(op.length, 6);
    });

    group('TSimpleOperation isEmpty property', () {
